...
<<<<<<< HEAD
  hub_resource_group_name       = data.terraform_remote_state.platform.outputs.templated_inputs.connectivity_resource_groups.hub.name
  hub_dns_resource_group_name   = data.terraform_remote_state.platform.outputs.templated_inputs.connectivity_resource_groups.private_dns.name
=======
...
>>>>>>> 4e59d77db184fd17299bc13da0a128c568207847
